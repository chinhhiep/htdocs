...
<div class="function">
	<a href="?act=product_new&txt_cat=<?php echo $id?>"><img src="images/add_new.gif" align="absmiddle" border="0" /></a> <a href="?act=product_new&txt_cat=<?php echo $id?>">Thêm sản phẩm mới</a>
</div>
<?php
...
$count	=	$min;
$r		=	$db->select("tgp_product","cat = '".$id."'","order by time desc limit $min, $max");
...
<tr class="tb_content">
	...
	<td style="text-align:right;"><?php echo $row["gia"]?></td>
	...
	<td><a href="?act=product_edit&id=<?php echo $row["id"]?>">Sửa</a></td>
...
<div class="function">
	<a href="?act=product_new&txt_cat=<?php echo $id?>"><img src="images/add_new.gif" align="absmiddle" border="0" /></a> <a href="?act=product_new&txt_cat=<?php echo $id?>">Đăng bài viết mới</a>
</div>