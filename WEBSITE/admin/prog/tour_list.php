...
<form name="frm_edit" id="frm_edit" action="?act=tour_list" enctype="multipart/form-data" method="post" style="margin:0px;" />
	...
	<tr>
		...
		<td width="65%" align="left">
			<textarea name="txt_tour_vn" class="inputbox" style="width:90%" rows="8"><?php echo get_bien("tour_list_vn")?></textarea>
		</td>
	</tr>
	<tr>
		<td width="35%" align="right" valign="top">Danh sách Tour trong nước : </td>
		<td width="65%" align="left">
			<textarea name="txt_tour_ot" class="inputbox" style="width:90%" rows="8"><?php echo get_bien("tour_list_ot")?></textarea>
		</td>
	</tr>
	<tr>
		<td colspan="2"></td>
