...
<div class="function">
	<a href="?act=cms_new&txt_cat=<?php echo $id?>"><img src="images/add_new.gif" align="absmiddle" border="0" /></a> <a href="?act=cms_new&txt_cat=<?php echo $id?>">Đăng bài viết mới</a>
</div>
<?php
...
<tr class="tb_content">
	...
	<td><a href="?act=cms_edit&id=<?php echo $row["id"]?>">Sửa</a></td>
