	...
	if ($func == "new")
	{
		...
		else
		{
			...
			if ($OK)
			{
				...
				if ($hinh)
				{
					$txt_hinh_2	= "thm_".$id.".".$file_type;
					img_resize($up_dir.$file_full_name,$up_dir.$txt_hinh_2,"w=150&h=100");
					$txt_hinh_3	= $id.".".$file_type;
					img_resize($up_dir.$file_full_name,$up_dir.$txt_hinh_3,"w=640&h=480");
