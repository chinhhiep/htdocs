...
?>
  <tr class="tb_foot">
	...
	<td>-</td>
    <td><a href="?act=gallery_menu_new&txt_cat=<?php echo $row["id"]?>"><img src="images/i_add.gif" border="0" /></a></td>
    <td>-</td>
    <td>-</td>
    <td>-</td>
  </tr>
...
?>
  <tr class="tb_content">
    ...
    <td><a href="?act=gallery_new&txt_cat=<?php echo $row2["id"]?>">Thêm hình</a></td>
    <td><a href="?act=gallery_menu_edit&id=<?php echo $row2["id"]?>">Sửa</a></td>
    <td><a href="?act=gallery_manager&delete=<?php echo $row2["id"]?>" onclick="return confirm('Tất cả bài viết sẽ bị mất hết\nBạn có chắc chắn không ?');">Xóa</a></td>
    <td><a href="?act=gallery_list&id=<?php echo $row2["id"]?>"><img src="images/go_right.gif" border="0" /></a></td>
  </tr>
<?php
	}
}
