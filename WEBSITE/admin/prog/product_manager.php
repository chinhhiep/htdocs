...
?>
  <tr class="tb_content">
    ...
    <td><a href="?act=product_new&txt_cat=<?php echo $row2["id"]?>">Thêm SP</a></td>
    ...
    <td><a href="?act=product_list&id=<?php echo $row2["id"]?>"><img src="images/go_right.gif" border="0" /></a></td>
  </tr>
<?php
	}
}
