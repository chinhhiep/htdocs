...
class    lg_system
{
     ...
     *******************************************/
    // main script, uses two other functions, which_os() and self::_browser_version() as needed
        ...
        */
        if (!$b_repeat) {
            ...
            */
            ...
            for ($i = 0; $i < $i_count; $i++) {
                ...
                if (stristr($browser_user_agent, $s_browser)) {
                    ...
                    switch ($browser_name) {
                        ...
                        case 'ns':
                            $safe_browser = false;
                            $version_number = self::_browser_version($browser_user_agent, 'mozilla');
                            break;
                        case 'moz':
                            /*
                            ...
                            */
                            ...
                            $moz_rv_full = self::_browser_version($browser_user_agent, 'rv');
                            ...
                            for ($i = 0; $i < $i_count; $i++) {
                                if (stristr($browser_user_agent, $moz_types[$i])) {
                                    ...
                                    $moz_version_number = self::_browser_version($browser_user_agent, $moz_version);
                                    break;
                                }
                            }
                            ...
                            $moz_release = self::_browser_version($browser_user_agent, 'gecko/');
                            /*
                            ...
                            */
                            ...
                            break;
                        case 'ie':
                            $version_number = self::_browser_version($browser_user_agent, $s_browser);
                        ...
                        */
                        ...
                        case 'omni':
                            $s_browser = 'safari';
                            $browser_name = 'saf';
                            $version_number = self::_browser_version( $browser_user_agent, 'applewebkit' );
                            break;
                        */
                        default:
                            $version_number = self::_browser_version($browser_user_agent, $s_browser);
            ...
            $a_os_data = self::which_os($browser_user_agent, $browser_name, $version_number);
    ...
    //function self::_browser_version( $browser_user_agent, $search_string, $substring_length )
    function _browser_version($browser_user_agent, $search_string)
    {
